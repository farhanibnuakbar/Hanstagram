...
public class FriendProfil3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_friend_profil3);
        ...
        imgleft.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(FriendProfil3.this, Beranda.class);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(FriendProfil3.this, Chat4.class);
                startActivity(intent);
            }
        });
    }
